package com.pankaj.journalApp.controller;

import com.pankaj.journalApp.entity.JournalEntry;
import com.pankaj.journalApp.entity.User;
import com.pankaj.journalApp.service.JournalEntryService;
import com.pankaj.journalApp.service.UserService;
...
public class JournalEntryController {
    ...
    @GetMapping("{userName}")
    public ResponseEntity<?> getAllJoutnalEntriesOfUser(@PathVariable String userName){ // localhost:8080/journal GET
    ...
    @GetMapping("id/{myId}")
    public ResponseEntity<JournalEntry> findByJournalId(@PathVariable ObjectId myId){
